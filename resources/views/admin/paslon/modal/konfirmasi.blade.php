<div id="konfirmasi{{ $data->id }}" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow :bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="konfirmasi{{ $data->id }}">
            ...
            <form action="{{ route('adminPeriode.update', $data->id) }}" method="POST" class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 :text-gray-400">
                    {{ $data->status == 'buat' ? 'apakah anda yakin akan melakukan pemilihan? konfirmasi' : 'apakah anda akan menyelesaikan pemilihan tahun ini?' }}
                </h3>
                ...
                <button data-modal-hide="konfirmasi{{ $data->id }}" type="button"
