...
<div id="insert" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-[60rem] max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow :bg-gray-700">
            ...
            <!-- Modal body -->
            <form enctype="multipart/form-data" method="post" action="{{ route('adminPaslon.store') }}"
                ...
                <div class="flex gap-2 w-full">
                    <div class="flex flex-col flex-1">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 :text-white">nomber
                            paslon</label>
                        <input type="text" readonly value="paslon-{{ $no }}" name="nomber_paslon"
                            id="name"
                ...
                <div class="flex gap-2 w-full">
                    <div class="flex flex-col flex-1">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Nama
                            ketua</label>
                        <input type="text" name="nama_ketua" id="name"
                            class="bg-gray-50 border  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 :bg-gray-600 :border-gray-500 :placeholder-gray-400 :text-white :focus:ring-primary-500 :focus:border-primary-500"
                            required="">
                    </div>
                    <div class="flex flex-col flex-1">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Nama
                            wakil</label>
                        <input type="text" name="nama_wakil" id="name"
                            class="bg-gray-50 border  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 :bg-gray-600 :border-gray-500 :placeholder-gray-400 :text-white :focus:ring-primary-500 :focus:border-primary-500"
                            required="">
                    </div>
                ...
                <div class="flex flex-col flex-1">
                    ...
                    <textarea type="text" name="visi"
                        class="bg-gray-50 h-[10rem] resize-none border  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 :bg-gray-600 :border-gray-500 :placeholder-gray-400 :text-white :focus:ring-primary-500 :focus:border-primary-500"
                        required="">
                ...
                <div class="flex flex-col flex-1">
                    ...
                    <textarea type="text" name="jargon"
                        class="bg-gray-50 h-[6rem] resize-none border  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 :bg-gray-600 :border-gray-500 :placeholder-gray-400 :text-white :focus:ring-primary-500 :focus:border-primary-500"
                        required="">
